...
class TestURLRequest : XCTestCase {
    ...
    func test_relativeURL() throws {
        ...
        // API marked unavailable for Skip: XCTAssertEqual(url.relativeString, "/get")
        ...
        // API marked unavailable for Skip: XCTAssertEqual(req.url!.absoluteURL.relativeString, "http://httpbin.org/get")
        ...
        // API marked unavailable for Skip: XCTAssertEqual(req.url!.baseURL?.relativeString, "http://httpbin.org")
        ...
        // API marked unavailable for Skip: XCTAssertEqual(nsreq.url!.absoluteURL.relativeString, "http://httpbin.org/get")
